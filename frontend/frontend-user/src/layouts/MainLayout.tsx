import { BarChart2, ChefHat, Home, LogOut, Plus, Refrigerator, ScrollText, ShoppingCart, Users, UserRound } from "lucide-react";
...
const navItems = [
  ...
  { to: "/recipes", label: "Công thức", icon: ChefHat },
