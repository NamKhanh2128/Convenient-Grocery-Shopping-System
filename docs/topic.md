...
Một số quy trình nghiệp vụ
4.1 Quy trình quản lý danh sách mua sắm
Người dùng tạo danh sách thực phẩm cần mua theo ngày hoặc tuần.
Danh sách được chia sẻ với các thành viên trong nhóm gia đình (nếu có).
Khi mua hàng, người dùng cập nhật trạng thái từng mặt hàng trong danh sách.
Sau khi mua xong, hệ thống tự động cập nhật thực phẩm vào kho lưu trữ tủ lạnh.
4.2 Quy trình quản lý thực phẩm trong tủ lạnh
Người dùng nhập thực phẩm mới vào hệ thống sau khi mua.
Hệ thống theo dõi thời gian sử dụng và nhắc nhở khi thực phẩm sắp hết hạn.
Khi chế biến món ăn, người dùng cập nhật số lượng thực phẩm đã sử dụng.
Hệ thống tự động điều chỉnh tồn kho thực phẩm sau mỗi lần sử dụng.
4.3 Quy trình gợi ý món ăn
Người dùng truy cập tính năng gợi ý món ăn.
Hệ thống kiểm tra thực phẩm hiện có trong tủ lạnh.
Hệ thống đề xuất các món ăn phù hợp và hiển thị công thức nấu ăn.
Người dùng có thể chọn món ăn và cập nhật số lượng thực phẩm đã sử dụng.
4.4 Quy trình lên kế hoạch bữa ăn
Người dùng chọn chế độ lên kế hoạch theo ngày hoặc tuần.
Hệ thống đề xuất thực đơn dựa trên thực phẩm sẵn có.
Người dùng xác nhận hoặc tùy chỉnh thực đơn theo sở thích.
Hệ thống tự động tạo danh sách mua sắm nếu có nguyên liệu thiếu hụt.